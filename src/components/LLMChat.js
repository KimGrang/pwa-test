...
const LLMChat = () => {
    ...
    // wllama 훅
    const { loadModel, chatCompletion, isLoaded, isLoading, progress, modelInfo: wllamaModelInfo, getAvailableModels, getLocalModels, } = useWllama({
        temperature: 0.7,
        topP: 0.9,
        maxTokens: 512,
    ...
    return (_jsxs("div", { className: 'llm-chat', children: [_jsxs("div", { className: 'chat-header', children: [_jsx("h2", { children: "\uD83E\uDD16 wllama \uC628\uB514\uBC14\uC774\uC2A4 LLM \uCC44\uD305" }), _jsxs("div", { className: `model-status-indicator ${modelStatus}`, children: [modelStatus === 'none' && _jsx("span", { children: "\uD83D\uDCCB \uBAA8\uB378\uC744 \uC120\uD0DD\uD558\uACE0 \uB85C\uB4DC\uD574\uC8FC\uC138\uC694" }), modelStatus === 'loading' && (_jsxs("span", { children: ["\u23F3 \uBAA8\uB378 \uB85C\uB529 \uC911... ", progress.toFixed(1), "%", _jsx("div", { className: 'progress-bar', children: _jsx("div", { className: 'progress-fill', style: { width: `${progress}%` } }) }), _jsxs("div", { className: 'loading-details', children: [loadingType === 'remote' && (_jsxs(_Fragment, { children: [progress < 25 && '모델 다운로드 중...', progress >= 25 && progress < 50 && '모델 초기화 중...', progress >= 50 && 'WebGPU 설정 중...'] })), loadingType === 'local' && (_jsxs(_Fragment, { children: [progress < 25 && '로컬 파일 로딩 중...', progress >= 25 && progress < 50 && '모델 초기화 중...', progress >= 50 && 'WebGPU 설정 중...'] }))] })] })), modelStatus === 'loaded' && _jsxs("span", { children: ["\u2705 ", modelInfo] }), modelStatus === 'error' && _jsxs("span", { children: ["\u274C ", modelInfo] })] }), _jsxs("div", { className: 'model-loading-methods', children: [_jsxs("div", { className: 'model-section', children: [_jsx("h3", { children: "\uD83C\uDF10 \uC6D0\uACA9 \uBAA8\uB378" }), _jsxs("div", { className: 'model-controls', children: [_jsx("select", { value: selectedModel, onChange: (e) => setSelectedModel(e.target.value), className: 'model-select', disabled: isModelLoading || isLoaded, children: availableModels.map((model) => (_jsx("option", { value: model, children: model }, model))) }), _jsx("button", { onClick: handleLoadRemoteModel, disabled: isModelLoading || isLoaded, className: 'load-model-btn', children: isModelLoading && loadingType === 'remote' ? `로딩 중... ${progress.toFixed(1)}%` : '원격 모델 로드' })] })] }), _jsx("div", { className: 'model-divider', children: _jsx("span", { children: "\uB610\uB294" }) }), _jsxs("div", { className: 'model-section', children: [_jsx("h3", { children: "\uD83D\uDCC1 \uB85C\uCEEC \uBAA8\uB378" }), _jsx("div", { className: 'model-warning', children: _jsx("p", { children: "\u2705 wllama\uB294 \uB85C\uCEEC GGUF \uD30C\uC77C\uC744 \uC9C1\uC811 \uC9C0\uC6D0\uD569\uB2C8\uB2E4. \uB85C\uCEEC \uBAA8\uB378\uC744 \uC120\uD0DD\uD558\uBA74 \uC2E4\uC81C \uD30C\uC77C\uC774 \uB85C\uB4DC\uB429\uB2C8\uB2E4." }) }), _jsxs("div", { className: 'model-controls', children: [_jsx("select", { value: selectedLocalModel, onChange: (e) => setSelectedLocalModel(e.target.value), className: 'model-select', disabled: isModelLoading || isLoaded, children: localModels.map((model) => (_jsxs("option", { value: model, children: [model.split('/').pop(), " (\uB85C\uCEEC)"] }, model))) }), _jsx("button", { onClick: handleLoadLocalModel, disabled: isModelLoading || isLoaded, className: 'load-model-btn', children: isModelLoading && loadingType === 'local' ? `로딩 중... ${progress.toFixed(1)}%` : '로컬 모델 로드' })] })] })] })] }), isLoaded && (_jsxs("div", { className: 'chat-interface', children: [_jsxs("div", { className: 'chat-controls', children: [_jsx("h3", { children: "\uD83D\uDCAC \uCC44\uD305" }), _jsx("button", { onClick: clearChat, className: 'clear-chat-btn', children: "\uD83D\uDDD1\uFE0F \uB300\uD654 \uCD08\uAE30\uD654" })] }), _jsxs("div", { className: 'chat-messages', children: [messages.length === 0 ? (_jsx("div", { className: 'empty-state', children: _jsx("p", { children: "\uC548\uB155\uD558\uC138\uC694! \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?" }) })) : (messages.map((message, index) => (_jsx("div", { className: `message ${message.role === 'user' ? 'user' : 'assistant'}`, children: _jsx("div", { className: 'message-content', children: message.content }) }, index)))), isLoading && (_jsx("div", { className: 'message assistant', children: _jsx("div", { className: 'message-content', children: _jsxs("div", { className: 'typing-indicator', children: [_jsx("span", {}), _jsx("span", {}), _jsx("span", {})] }) }) }))] }), _jsxs("div", { className: 'chat-input', children: [_jsx("textarea", { value: inputMessage, onChange: (e) => setInputMessage(e.target.value), onKeyPress: handleKeyPress, placeholder: '\uBA54\uC2DC\uC9C0\uB97C \uC785\uB825\uD558\uC138\uC694...', disabled: isLoading, className: 'message-input' }), _jsx("button", { onClick: handleSendMessage, disabled: isLoading || !inputMessage.trim(), className: 'send-btn', children: "\uC804\uC1A1" })] })] })), !isLoaded && modelStatus !== 'loading' && (_jsx("div", { className: 'model-loading-guide', children: _jsxs("div", { className: 'guide-content', children: [_jsx("h3", { children: "\uD83D\uDE80 wllama \uBAA8\uB378 \uB85C\uB529 \uAC00\uC774\uB4DC" }), _jsxs("div", { className: 'guide-steps', children: [_jsxs("div", { className: 'step', children: [_jsx("span", { className: 'step-number', children: "1" }), _jsx("p", { children: "\uC6D0\uACA9 \uBAA8\uB378: \uB4DC\uB86D\uB2E4\uC6B4\uC5D0\uC11C \uC6D0\uD558\uB294 \uBAA8\uB378\uC744 \uC120\uD0DD\uD558\uACE0 \"\uC6D0\uACA9 \uBAA8\uB378 \uB85C\uB4DC\" \uBC84\uD2BC\uC744 \uD074\uB9AD\uD558\uC138\uC694" })] }), _jsxs("div", { className: 'step', children: [_jsx("span", { className: 'step-number', children: "2" }), _jsx("p", { children: "\uB85C\uCEEC \uBAA8\uB378: \uB85C\uCEEC GGUF \uD30C\uC77C\uC744 \uC120\uD0DD\uD558\uACE0 \"\uB85C\uCEEC \uBAA8\uB378 \uB85C\uB4DC\" \uBC84\uD2BC\uC744 \uD074\uB9AD\uD558\uC138\uC694" })] }), _jsxs("div", { className: 'step', children: [_jsx("span", { className: 'step-number', children: "3" }), _jsx("p", { children: "\uBAA8\uB378 \uB85C\uB529\uC774 \uC644\uB8CC\uB418\uBA74 \uCC44\uD305 \uC778\uD130\uD398\uC774\uC2A4\uAC00 \uB098\uD0C0\uB0A9\uB2C8\uB2E4" })] })] }), _jsxs("div", { className: 'model-suggestions', children: [_jsx("h4", { children: "\uD83D\uDCA1 \uCD94\uCC9C \uBAA8\uB378\uB4E4:" }), _jsxs("ul", { children: [_jsxs("li", { children: [_jsx("code", { children: "TinyLlama-1.1B-Chat-v1.0-q4f16_1" }), " - \uBE60\uB978 \uC751\uB2F5, \uACBD\uB7C9 \uBAA8\uB378 (\uAD8C\uC7A5)"] }), _jsxs("li", { children: [_jsx("code", { children: "Phi-2-q4f16_1" }), " - Microsoft\uC758 \uD6A8\uC728\uC801\uC778 \uBAA8\uB378"] }), _jsxs("li", { children: [_jsx("code", { children: "Mistral-7B-Instruct-v0.2-q4f16_1" }), " - \uACE0\uD488\uC9C8 \uC751\uB2F5, \uC911\uAC04 \uD06C\uAE30"] })] }), _jsx("h4", { children: "\u2705 wllama \uD2B9\uC9D5:" }), _jsxs("ul", { children: [_jsx("li", { children: "wllama\uB294 \uB85C\uCEEC GGUF \uD30C\uC77C\uC744 \uC9C1\uC811 \uC9C0\uC6D0\uD569\uB2C8\uB2E4" }), _jsx("li", { children: "WebAssembly\uB97C \uC0AC\uC6A9\uD558\uC5EC \uBE0C\uB77C\uC6B0\uC800\uC5D0\uC11C \uC9C1\uC811 \uC2E4\uD589\uB429\uB2C8\uB2E4" }), _jsx("li", { children: "\uB124\uD2B8\uC6CC\uD06C \uC5C6\uC774\uB3C4 \uB85C\uCEEC \uBAA8\uB378\uC744 \uC0AC\uC6A9\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4" })] }), _jsx("h4", { children: "\u26A1 \uC131\uB2A5 \uD301:" }), _jsxs("ul", { children: [_jsx("li", { children: "\uCCAB \uBC88\uC9F8 \uB85C\uB529\uC740 \uC2DC\uAC04\uC774 \uAC78\uB9B4 \uC218 \uC788\uC2B5\uB2C8\uB2E4 (\uBAA8\uB378 \uB2E4\uC6B4\uB85C\uB4DC/\uB85C\uB529)" }), _jsx("li", { children: "WebGPU\uB97C \uC9C0\uC6D0\uD558\uB294 \uBE0C\uB77C\uC6B0\uC800\uC5D0\uC11C \uB354 \uBE60\uB978 \uC131\uB2A5\uC744 \uC5BB\uC744 \uC218 \uC788\uC2B5\uB2C8\uB2E4" }), _jsx("li", { children: "\uB85C\uCEEC \uBAA8\uB378\uC740 \uB124\uD2B8\uC6CC\uD06C \uC5C6\uC774\uB3C4 \uC0AC\uC6A9\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4" })] })] })] }) }))] }));
};
