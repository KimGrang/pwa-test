...
//         // 직접 URL 사용 (외부 URL인 경우)
//         const modelUrl = modelPath.startsWith('http') ? modelPath : new URL(modelPath, window.location.origin).href;
